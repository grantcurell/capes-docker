...
#######################################
# Delete a container if it already exists
# Arguments:
#   1) The name of the container to check
# Returns:
#   None
#######################################
stop_and_delete_if_running () {

  CONTAINER=$1

  : '

  TODO: This is a more elegant way of doing things, however, it did not behave
  correctly. When containers did not exist, it would still try to run the removal.
  set +e
...
if ${ETHERPAD} ; then
  ...
  stop_and_delete_if_running capes-etherpad-mysql
...
if ${GITEA} ; then
  ...
  stop_and_delete_if_running capes-gitea-mysql
...
if ${THEHIVE} ; then
  ...
  stop_and_delete_if_running capes-thehive-elasticsearch
...
if ${ROCKETCHAT} ; then
  ...
  stop_and_delete_if_running capes-rocketchat-mongo
...
if ${PORTAINER} ; then
  ...
  stop_and_delete_if_running capes-portainer
...
stop_and_delete_if_running capes-landing-page
...
if ${CYBERCHEF} ; then
  ...
  stop_and_delete_if_running capes-cyberchef
...
if ${GITEA} ; then
  ...
  stop_and_delete_if_running capes-gitea
...
if ${ETHERPAD} ; then
  ...
  stop_and_delete_if_running capes-etherpad
...
if ${THEHIVE} ; then
  ...
  stop_and_delete_if_running capes-thehive
...
if ${ROCKETCHAT} ; then
  ...
  stop_and_delete_if_running capes-rocketchat
...
if ${MUMBLE} ; then
  ...
  stop_and_delete_if_running capes-mumble
...
stop_and_delete_if_running capes-elasticsearch-1
stop_and_delete_if_running capes-elasticsearch-2
stop_and_delete_if_running capes-elasticsearch-3
...
stop_and_delete_if_running capes-kibana
...
stop_and_delete_if_running capes-heartbeat
...
stop_and_delete_if_running capes-metricbeat
